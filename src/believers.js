...
export const CHARACTERS = [
  /* ── 既有圖：對上固定角色 ── */
  {
    ...
    img: P('student-1.jpg'), hot: true, irreverent: 0.3,
  ...
  },
  {
    ...
    img: P('y2k-1.jpg'), hot: true, irreverent: 0.45,
  ...
  },
  {
    ...
    img: P('kgirl-1.jpg'), hot: true, irreverent: 0.25,
  ...
  },
  {
    ...
    img: P('kgirl-2.jpg'), hot: true, irreverent: 0.3,
  ...
  },
  {
    ...
    img: P('auntie-1.jpg'), hot: false, irreverent: 0.15,
  ...
  },
  {
    ...
    img: P('89-1.jpg'), hot: false, irreverent: 0.7,
  ...
  },
  {
    ...
    img: P('89-2.jpg'), hot: false, irreverent: 0.85,
  ...
  },
  {
    ...
    img: P('boss-1.jpg'), hot: false, irreverent: 0.5,
  ...
  },
  {
    ...
    img: P('bro-1.jpg'), hot: false, irreverent: 0.9,
  ...
  },
  {
    ...
    img: P('elder-1.jpg'), hot: false, irreverent: 0.1,
  ...
  /* ── 新增反差人設（缺圖：依 genPrompt 生圖後補 img） ── */
  {
    ...
    img: P('knet.jpg'), hot: true, irreverent: 0.55,
  ...
  },
  {
    ...
    img: P('jpgirl.jpg'), hot: true, irreverent: 0.4,
  ...
  },
  {
    ...
    img: P('89c.jpg'), hot: false, irreverent: 0.9,
  ...
  },
  {
    ...
    img: P('streamer.jpg'), hot: false, irreverent: 0.8,
  ...
  },
  {
    ...
    img: P('spiritgirl.jpg'), hot: true, irreverent: 0.2,
  ...
  },
  {
    ...
    img: P('councilor.jpg'), hot: false, irreverent: 0.45,
  ...
  },
  {
    ...
    img: P('xishi.jpg'), hot: true, irreverent: 0.6,
  ...
  // ── tier 1（rep≥15）小有名氣：地方頭面人物 ──
  {
    ...
    img: P('liyoutube.jpg'), hot: false, irreverent: 0.7, region: '台北', mood: '想拍片蹭一波', topic: '事業',
  ...
  },
  {
    ...
    img: P('coser.jpg'), hot: true, irreverent: 0.5, region: '板橋', mood: '出完場順道來', topic: '財運',
  ...
  },
  {
    ...
    img: P('gymbro.jpg'), hot: false, irreverent: 0.6, region: '內湖', mood: '剛練完直接來', topic: '健康',
  ...
  // ── tier 2（rep≥30）廟口熟面孔：仕紳/小老闆 ──
  {
    ...
    img: P('factory.jpg'), hot: false, irreverent: 0.4, region: '台中', mood: '為公司求運', topic: '事業',
  ...
  },
  {
    ...
    img: P('doctor.jpg'), hot: true, irreverent: 0.3, region: '信義', mood: '低調來問', topic: '財運',
  ...
  },
  {
    ...
    img: P('realtor.jpg'), hot: false, irreverent: 0.55, region: '新北', mood: '業績焦慮', topic: '財運',
  ...
  },
  {
    ...
    img: P('councilman2.jpg'), hot: false, irreverent: 0.5, region: '高雄', mood: '選情緊張', topic: '事業',
  ...
  // ── tier 4（rep≥60）地方名師：權貴 ──
  {
    ...
    img: P('legislator.jpg'), hot: false, irreverent: 0.45, region: '台北', mood: '帶隨扈來', topic: '訴訟',
  ...
  },
  {
    ...
    img: P('tycoonwife.jpg'), hot: true, irreverent: 0.6, region: '天母', mood: '帶名牌包來', topic: '感情',
  ...
  },
  {
    ...
    img: P('gangboss.jpg'), hot: false, irreverent: 0.5, region: '艋舺', mood: '一群小弟簇擁', topic: '討債',
  ...
  // ── tier 5（rep≥75）全國知名：頂層 ──
  {
    ...
    img: P('mayor.jpg'), hot: false, irreverent: 0.4, region: '台北', mood: '微服私訪', topic: '事業',
  ...
  },
  {
    ...
    img: P('conglomerate.jpg'), hot: false, irreverent: 0.35, region: '台北', mood: '搭名車來', topic: '財運',
...
export function characterToBeliever(c) {
  return {
    ...
    portrait: c.img ?? FALLBACK_BY_GENDER[c.gender] ?? P('elder-1.jpg'),
    hasImage: !!c.img,
    hot: c.hot,
...
export function missingImagePrompts() {
  return CHARACTERS.filter((c) => !c.img).map((c) => ({ id: c.id, name: c.name, label: c.label, file: `${c.id}.jpg`, prompt: c.genPrompt }));
}
